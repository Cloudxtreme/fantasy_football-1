...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PlayerStat', fields ['week', 'season', 'player', 'stat_id']
        db.create_unique('website_playerstat', ['week', 'season', 'player_id', 'stat_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlayerStat', fields ['week', 'season', 'player', 'stat_id']
        db.delete_unique('website_playerstat', ['week', 'season', 'player_id', 'stat_id'])
