...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.espn_id'
        db.add_column('website_player', 'espn_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.espn_id'
        db.delete_column('website_player', 'espn_id')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 7, 0, 0)'}),
