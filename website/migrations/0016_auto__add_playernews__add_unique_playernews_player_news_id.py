...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlayerNews'
        db.create_table('website_playernews', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(related_name='news', to=orm['website.Player'])),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('published', self.gf('django.db.models.fields.DateTimeField')()),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('mobile_link', self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True)),
            ('news_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('website', ['PlayerNews'])

        # Adding unique constraint on 'PlayerNews', fields ['player', 'news_id']
        db.create_unique('website_playernews', ['player_id', 'news_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlayerNews', fields ['player', 'news_id']
        db.delete_unique('website_playernews', ['player_id', 'news_id'])

        # Deleting model 'PlayerNews'
        db.delete_table('website_playernews')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 8, 0, 0)'}),
        ...
        'website.player': {
            ...
            'espn_id': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'website.playernews': {
            'Meta': {'unique_together': "(('player', 'news_id'),)", 'object_name': 'PlayerNews'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'mobile_link': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'news_id': ('django.db.models.fields.IntegerField', [], {}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'news'", 'to': "orm['website.Player']"}),
