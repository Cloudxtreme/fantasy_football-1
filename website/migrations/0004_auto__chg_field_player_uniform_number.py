...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.uniform_number'
        db.alter_column('website_player', 'uniform_number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Player.uniform_number'
        raise RuntimeError("Cannot reverse this migration. 'Player.uniform_number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Player.uniform_number'
        db.alter_column('website_player', 'uniform_number', self.gf('django.db.models.fields.IntegerField')())
