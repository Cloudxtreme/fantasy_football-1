...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.url'
        db.add_column('website_league', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'League.league_type'
        db.add_column('website_league', 'league_type',
                      self.gf('django.db.models.fields.CharField')(default='ESPN', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.url'
        db.delete_column('website_league', 'url')

        # Deleting field 'League.league_type'
        db.delete_column('website_league', 'league_type')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 20, 0, 0)'}),
