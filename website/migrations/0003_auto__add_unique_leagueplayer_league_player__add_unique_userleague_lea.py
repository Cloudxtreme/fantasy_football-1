...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LeaguePlayer', fields ['league', 'player']
        db.create_unique('website_leagueplayer', ['league_id', 'player_id'])

        # Adding unique constraint on 'UserLeague', fields ['league', 'user_profile']
        db.create_unique('website_userleague', ['league_id', 'user_profile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserLeague', fields ['league', 'user_profile']
        db.delete_unique('website_userleague', ['league_id', 'user_profile_id'])

        # Removing unique constraint on 'LeaguePlayer', fields ['league', 'player']
        db.delete_unique('website_leagueplayer', ['league_id', 'player_id'])
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 18, 0, 0)'}),
