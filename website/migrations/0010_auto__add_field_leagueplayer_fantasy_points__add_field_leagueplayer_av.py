...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeaguePlayer.fantasy_points'
        db.add_column('website_leagueplayer', 'fantasy_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LeaguePlayer.average_points'
        db.add_column('website_leagueplayer', 'average_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LeaguePlayer.last_points'
        db.add_column('website_leagueplayer', 'last_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LeaguePlayer.percent_own'
        db.add_column('website_leagueplayer', 'percent_own',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'LeaguePlayer.percent_starting'
        db.add_column('website_leagueplayer', 'percent_starting',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'LeaguePlayer.percent_change'
        db.add_column('website_leagueplayer', 'percent_change',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeaguePlayer.fantasy_points'
        db.delete_column('website_leagueplayer', 'fantasy_points')

        # Deleting field 'LeaguePlayer.average_points'
        db.delete_column('website_leagueplayer', 'average_points')

        # Deleting field 'LeaguePlayer.last_points'
        db.delete_column('website_leagueplayer', 'last_points')

        # Deleting field 'LeaguePlayer.percent_own'
        db.delete_column('website_leagueplayer', 'percent_own')

        # Deleting field 'LeaguePlayer.percent_starting'
        db.delete_column('website_leagueplayer', 'percent_starting')

        # Deleting field 'LeaguePlayer.percent_change'
        db.delete_column('website_leagueplayer', 'percent_change')
    ...
    models = {
        ...
        'website.leagueplayer': {
            ...
            'average_points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'fantasy_points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_points': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
