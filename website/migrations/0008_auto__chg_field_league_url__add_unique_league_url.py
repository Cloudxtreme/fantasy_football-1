...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'League.url'
        db.alter_column('website_league', 'url', self.gf('django.db.models.fields.URLField')(default='http://google.com', unique=True, max_length=200))
        # Adding unique constraint on 'League', fields ['url']
        db.create_unique('website_league', ['url'])


    def backwards(self, orm):
        # Removing unique constraint on 'League', fields ['url']
        db.delete_unique('website_league', ['url'])


        # Changing field 'League.url'
        db.alter_column('website_league', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 24, 0, 0)'}),
