...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'League.record'
        db.add_column('website_league', 'record',
                      self.gf('django.db.models.fields.CharField')(default='0 - 0', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'League.record'
        db.delete_column('website_league', 'record')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 0, 0)'}),
